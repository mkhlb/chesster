...
piece_square_tables = {
  'P' : ( 000, 000, 000, 000, 000, 000, 000, 000, #8
           ...
           10,  10,  20,  30,  30,  20,  10,  10, #6
            5,   5,  10,  27,  27,  10,   5,   5, #5
          000, 000, 000,  25,  25, 000, 000, 000, #4
            5,  -5, -10, 000, 000, -10,  -5,   5, #3
            5,  10,  10, -25, -25,  10,  10,   5, #2
          000, 000, 000, 000, 000, 000, 000, 000),#1
#          A    B    C    D    E    F    G    H
  'B' : ( -20, -10, -10, -10, -10, -10, -10, -20, #8
          -10, 000, 000, 000, 000, 000, 000, -10, #7
          -10, 000,   5,  10,  10,   5, 000, -10, #6
          -10,   5,   5,  10,  10,   5,   5, -10, #5
          -10, 000,  10,  10,  10,  10, 000, -10, #4
          -10,  10,  10,  10,  10,  10,  10, -10, #3
          -10,   5, 000, 000, 000, 000,   5, -10, #2
          -20, -10, -40, -10, -10, -40, -10, -20),#1
#          A    B    C    D    E    F    G    H
  'R' : ( 000, 000, 000, 000, 000, 000, 000, 000, #8
            5,  10,  10,  10,  10,  10,  10,   5, #7
           -5, 000, 000, 000, 000, 000, 000,  -5, #6
           -5, 000, 000, 000, 000, 000, 000,  -5, #5
           -5, 000, 000, 000, 000, 000, 000,  -5, #4
           -5, 000, 000, 000, 000, 000, 000,  -5, #3
           -5, 000, 000, 000, 000, 000, 000,  -5, #2
          000, 000, 000,   5,   5, 000, 000, 000),#1
#          A    B    C    D    E    F    G    H
  'N' : ( -50, -40, -30, -30, -30, -30, -40, -50, #8
          -40, -20, 000, 000, 000, 000, -20, -40, #7
          -30, 000,  10,  15,  15,  10, 000, -30, #6
          -30,   5,  15,  20,  20,  15,   5, -30, #5
          -30, 000,  15,  20,  20,  15, 000, -30, #4
          -30,   5,  10,  15,  15,  10,   5, -30, #3
          -40, -20, 000,   5,   5, 000, -20, -40, #2
          -50, -40, -20, -30, -30, -20, -40, -50),#1
#          A    B    C    D    E    F    G    H
  'Q' : ( -20, -10, -10,  -5,  -5, -10, -10, -20, #8
          -10, 000, 000, 000, 000, 000, 000, -10, #7
          -10, 000,   5,   5,   5,   5, 000, -10, #6
           -5, 000,   5,   5,   5,   5, 000,  -5, #5
          000, 000,   5,   5,   5,   5, 000,  -5, #4
          -10, 000,   5,   5,   5,   5, 000, -10, #3
          -10, 000, 000, 000, 000, 000, 000, -10, #2
          000, 000, 000, 000, 000, 000, 000, 000),#1
#          A    B    C    D    E    F    G    H
  'K' : (   5,  25,  25, -50, -50,  25,  40, -30, #8
          -15,   5,  20,  30,  30,  20,  5,    5, #7
          -30,   5, -30,  20, -30,  10,  20, -10, #6
          -25,  25,   5,  -5, -10,   5,   0, -25, #5
          -25, -20, -25, -15, -25, -25,  -5, -25, #4
          -25, -20, -20, -40, -30, -15, -15, -15, #3
           -5,   5, -10, -25, -30, -10,   5,   0, #2
            9,  15,   0,  -5,   0,   0,  20,  10) #1
#          A    B    C    D    E    F    G    H
}
