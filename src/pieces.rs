...
impl Square {
  pub fn is_my_piece(self) -> bool {
    matches!(
      self,
      Square::MyPawn | Square::MyKnight | Square::MyBishop | Square::MyRook | Square::MyQueen | Square::MyKing
    )
  }
  ...
  pub fn is_opponent_piece(self) -> bool {
    matches!(
      self,
      Square::OpponentPawn | Square::OpponentKnight | Square::OpponentBishop | Square::OpponentRook | Square::OpponentQueen | Square::OpponentKing
    )
  }
  ...
  pub fn value(self, position : usize) -> i32 {
